...
int maxVal_count(int* start, int* end, unsigned long long& count_compare) {
	int mx = *start;
...
int minVal_count(int* start, int* end, unsigned long long& count_compare) {
	int mn = *start;
	for (int* run = start; ++count_compare && run < end; run++)
...
// insertion sort
void insertionSort_count(int* src, int n, unsigned long long& count_compare) {
...
// bubble sort
void bubbleSort_count(int* src, int n, unsigned long long& count_compare) {
	for (int i = 0; ++count_compare && i < n; ++i) {
...
// heap sort
void minHeapRebuild_count(int* src, int n, int pos, unsigned long long& count_compare) {
	int _pos = pos;
...
void minHeapBuild_count(int* src, int n, unsigned long long& count_compare) {
	for (int i = (n - 2) / 2; ++count_compare && i >= 0; i--)
		minHeapRebuild_count(src, n, i, count_compare);
}
void heapSort_count(int* src, int n, unsigned long long& count_compare) {
	int m = n;
...
// merge sort
void mergeSort_count(int* src, int n, unsigned long long& count_compare) {
	mergeSortHelper_count(src, 0, n - 1, count_compare);
}
void mergeSortHelper_count(int* src, int start, int end, unsigned long long& count_compare) {
...
void mergeArrays_count(int* src, int start, int mid, int end, unsigned long long& count_compare) {
...
//quick sort
void quickSort_count(int* src, int n, unsigned long long& count_compare) {
	quickSortHelper_count(src, 0, n - 1, count_compare);
}
void quickSortHelper_count(int* src, int left, int right, unsigned long long& count_compare) {
...
int partitionForQuickSort_count(int* src, int left, int right, unsigned long long& count_compare) {
	srand(time(NULL));
...
// radix sort
void digitSort_count(int* src, int n, int exp, unsigned long long& count_compare) {
	int* pos = new int[10]();
	int* dst = new int[n];
...
void radixSort_count(int* src, int n, unsigned long long& count_compare) {
...
// shaker sort
void shakerSort_count(int* src, int n, unsigned long long& count_compare) {
...
// shell sort
void shellSort_count(int* src, int n, unsigned long long& count_compare) {
...
//counting sort
void countingSort_count(int* src, int n, unsigned long long& count_compare) {
	int mx = maxVal_count(src, src + n, count_compare);
...
//flash sort
void flashSort_count(int* src, int n, unsigned long long& count_compare) {
	int mx = maxVal_count(src, src + n, count_compare);
